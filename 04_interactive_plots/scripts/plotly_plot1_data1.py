...
# Plot data
fig = px.scatter(df_size_reduced, x="year", y="AverageTemperatureCelsius", color="Country", symbol="Country")
...
if len(sys.argv) > 1 and sys.argv[1] == '1':
    ...
    filename = os.path.join(output_dir, "plotly_plot1_data1.png")  # Full path
